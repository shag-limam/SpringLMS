...
public class BookController {
	...
	@RequestMapping(value = "/listUserUI", method = RequestMethod.GET)
	public String showUserBooksPage(Model model) {
		model.addAttribute("books", bookService.getAll());
		return "/book/listUserBook"; // Assurez-vous que le fichier listUserBook.html existe dans le répertoire des templates
	}
